...
route::get('on_the_way/{id}' ,action: [AdminController::class,'on_the_way'])->middleware(['auth', 'admin']);
route::get('delivered/{id}' ,action: [AdminController::class,'delivered'])->middleware(['auth', 'admin']);
route::get('print_pdf/{id}' ,action: [AdminController::class,'print_pdf'])->middleware(['auth', 'admin']);
